...
var AnsUserCount_Result__DEFAULT *error.Error
func (p *AnsUserCount) GetResult_() *error.Error {
  if !p.IsSetResult_() {
...
var AnsCustomQuery_Result__DEFAULT *error.Error
func (p *AnsCustomQuery) GetResult_() *error.Error {
  if !p.IsSetResult_() {
