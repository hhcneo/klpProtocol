...
func (p *ReqCategoryList) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}
...
func (p *ReqSearchRoom) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}
...
type ReqRoomInfoList struct {
  RequestKey ClientRequestKey `thrift:"request_key,1,required" db:"request_key" json:"request_key"`
  RoomIds []RoomId `thrift:"room_ids,2,required" db:"room_ids" json:"room_ids"`
}
...
func (p *ReqRoomInfoList) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}
...
type ForwardToLobbyContents struct {
  RequestKey ClientRequestKey `thrift:"request_key,1,required" db:"request_key" json:"request_key"`
  ContentsMessage Buffer `thrift:"contents_message,2,required" db:"contents_message" json:"contents_message"`
}
...
func (p *ForwardToLobbyContents) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}

func (p *ForwardToLobbyContents) GetContentsMessage() Buffer {
