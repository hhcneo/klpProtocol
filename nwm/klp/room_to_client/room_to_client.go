...
const (
  MessageType_kForwardFromRoomContents MessageType = 1
)

func (p MessageType) String() string {
  switch p {
  case MessageType_kForwardFromRoomContents: return "kForwardFromRoomContents"
  }
  return "<UNSET>"
}
...
func MessageTypeFromString(s string) (MessageType, error) {
  switch s {
  case "kForwardFromRoomContents": return MessageType_kForwardFromRoomContents, nil 
  }
...
// Attributes:
//  - ContentsMessage
type ForwardFromRoomContents struct {
  ContentsMessage protocol.Buffer `thrift:"contents_message,1,required" db:"contents_message" json:"contents_message"`
}

func NewForwardFromRoomContents() *ForwardFromRoomContents {
  return &ForwardFromRoomContents{}
}


func (p *ForwardFromRoomContents) GetContentsMessage() protocol.Buffer {
  return p.ContentsMessage
}
func (p *ForwardFromRoomContents) Read(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *ForwardFromRoomContents)  ReadField1(ctx context.Context, iprot thrift.TProtocol) error {
...
func (p *ForwardFromRoomContents) Write(ctx context.Context, oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin(ctx, "ForwardFromRoomContents"); err != nil {
...
func (p *ForwardFromRoomContents) writeField1(ctx context.Context, oprot thrift.TProtocol) (err error) {
...
func (p *ForwardFromRoomContents) Equals(other *ForwardFromRoomContents) bool {
  if p == other {
    return true
...
func (p *ForwardFromRoomContents) String() string {
  if p == nil {
    return "<nil>"
  }
  return fmt.Sprintf("ForwardFromRoomContents(%+v)", *p)
}

func (p *ForwardFromRoomContents) Validate() error {
  return nil
}
