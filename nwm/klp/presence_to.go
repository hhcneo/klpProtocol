...
var AnsInsertUser_Result__DEFAULT *Error
func (p *AnsInsertUser) GetResult_() *Error {
  if !p.IsSetResult_() {
...
func (p *AnsInsertUser) GetRequestKey() RequestKey {
  return p.RequestKey
}

func (p *AnsInsertUser) GetSsn() Ssn {
  return p.Ssn
}

func (p *AnsInsertUser) GetGsn() Gsn {
  return p.Gsn
}
...
func (p *AnsInsertUser) GetTraceID() Buffer {
  return p.TraceID
}
...
var AnsDeleteUser_Result__DEFAULT *Error
func (p *AnsDeleteUser) GetResult_() *Error {
  if !p.IsSetResult_() {
...
func (p *AnsDeleteUser) GetRequestKey() RequestKey {
  return p.RequestKey
}

func (p *AnsDeleteUser) GetSsn() Ssn {
  return p.Ssn
}

func (p *AnsDeleteUser) GetGsn() Gsn {
  return p.Gsn
}

func (p *AnsDeleteUser) GetTraceID() Buffer {
  return p.TraceID
}
...
type AnsSelectUser struct {
  ...
  Gsn Gsn `thrift:"gsn,4,required" db:"gsn" json:"gsn"`
  GatewayIP string `thrift:"gateway_ip,5,required" db:"gateway_ip" json:"gateway_ip"`
  GatewayAddressPmb PmbAddress `thrift:"gateway_address_pmb,6,required" db:"gateway_address_pmb" json:"gateway_address_pmb"`
...
var AnsSelectUser_Result__DEFAULT *Error
func (p *AnsSelectUser) GetResult_() *Error {
  if !p.IsSetResult_() {
...
func (p *AnsSelectUser) GetRequestKey() RequestKey {
  return p.RequestKey
}

func (p *AnsSelectUser) GetSsn() Ssn {
  return p.Ssn
}

func (p *AnsSelectUser) GetGsn() Gsn {
  return p.Gsn
}
...
func (p *AnsSelectUser) GetGatewayAddressPmb() PmbAddress {
  return p.GatewayAddressPmb
}

func (p *AnsSelectUser) GetTraceID() Buffer {
  return p.TraceID
}
...
func (p *AnsChangeLobby) GetRequestKey() RequestKey {
  return p.RequestKey
}
var AnsChangeLobby_Result__DEFAULT *Error
func (p *AnsChangeLobby) GetResult_() *Error {
  if !p.IsSetResult_() {
...
func (p *AnsChangeLobby) GetTraceID() Buffer {
  return p.TraceID
}
