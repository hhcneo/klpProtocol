...
type ForwardToClient struct {
  ...
  ServerType protocol.ServerType `thrift:"server_type,3,required" db:"server_type" json:"server_type"`
  ContentsMessage protocol.Buffer `thrift:"contents_message,4,required" db:"contents_message" json:"contents_message"`
}
...
func (p *ForwardToClient) GetServerType() protocol.ServerType {
  return p.ServerType
}
...
func (p *ReqDisconnectUser) GetRequestKey() protocol.RequestKey {
  return p.RequestKey
}

func (p *ReqDisconnectUser) GetSsn() protocol.Ssn {
  return p.Ssn
}

func (p *ReqDisconnectUser) GetGsn() protocol.Gsn {
  return p.Gsn
}
...
func (p *NtfDisconnectUser) GetSsn() protocol.Ssn {
  return p.Ssn
}

func (p *NtfDisconnectUser) GetGsn() protocol.Gsn {
  return p.Gsn
}
...
func (p *ForwardToClients) GetServerType() protocol.ServerType {
  return p.ServerType
}
