...
type NtfToKlpGatewayLogic struct {
  ...
  Body protocol.Buffer `thrift:"body,7,required" db:"body" json:"body"`
}
...
func (p *NtfToKlpGatewayLogic) GetType() protocol.Buffer {
  return p.Type
}

func (p *NtfToKlpGatewayLogic) GetSsn() protocol.Ssn {
  return p.Ssn
}

func (p *NtfToKlpGatewayLogic) GetGsn() protocol.Gsn {
  return p.Gsn
}

func (p *NtfToKlpGatewayLogic) GetRoutingKey() protocol.Buffer {
  return p.RoutingKey
}

func (p *NtfToKlpGatewayLogic) GetRoomID() protocol.RoomId {
  return p.RoomID
}

func (p *NtfToKlpGatewayLogic) GetCommand() protocol.Buffer {
  return p.Command
}

func (p *NtfToKlpGatewayLogic) GetBody() protocol.Buffer {
  return p.Body
}
