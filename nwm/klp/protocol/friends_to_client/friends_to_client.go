...
type AnsUserLocations struct {
  ...
  Locations map[protocol.Gsn]*protocol.UserLocation `thrift:"locations,2,required" db:"locations" json:"locations"`
}
...
func (p *AnsUserLocations) GetRequestKey() protocol.ClientRequestKey {
  return p.RequestKey
}

func (p *AnsUserLocations) GetLocations() map[protocol.Gsn]*protocol.UserLocation {
  return p.Locations
}
...
func (p *AnsUserLocations)  ReadField2(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  tMap := make(map[protocol.Gsn]*protocol.UserLocation, size)
  p.Locations =  tMap
  for i := 0; i < size; i ++ {
var _key0 protocol.Gsn
...
func (p *AnsFriendLocations) GetRequestKey() protocol.ClientRequestKey {
  return p.RequestKey
}

func (p *AnsFriendLocations) GetLocations() map[protocol.Gsn]*protocol.UserLocation {
  return p.Locations
}
