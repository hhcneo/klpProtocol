...
var AnsTournamentLogic_Result__DEFAULT *error.Error
func (p *AnsTournamentLogic) GetResult_() *error.Error {
  if !p.IsSetResult_() {
...
var AnsTnmtRoomInfo_Result__DEFAULT *error.Error
func (p *AnsTnmtRoomInfo) GetResult_() *error.Error {
  if !p.IsSetResult_() {
