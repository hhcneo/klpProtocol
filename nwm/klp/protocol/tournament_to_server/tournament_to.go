...
type AnsTournamentLogic struct {
  ...
  Command protocol.Buffer `thrift:"command,5,required" db:"command" json:"command"`
  ResponseData protocol.Buffer `thrift:"response_data,6,required" db:"response_data" json:"response_data"`
...
var AnsTournamentLogic_Result__DEFAULT *klperror.Error
func (p *AnsTournamentLogic) GetResult_() *klperror.Error {
  if !p.IsSetResult_() {
...
func (p *AnsTournamentLogic) GetRequestKey() protocol.RequestKey {
  return p.RequestKey
}

func (p *AnsTournamentLogic) GetSsn() protocol.Ssn {
  return p.Ssn
}

func (p *AnsTournamentLogic) GetRoomID() protocol.RoomId {
  return p.RoomID
}

func (p *AnsTournamentLogic) GetCommand() protocol.Buffer {
  return p.Command
}

func (p *AnsTournamentLogic) GetResponseData() protocol.Buffer {
  return p.ResponseData
}

func (p *AnsTournamentLogic) GetTraceID() protocol.Buffer {
  return p.TraceID
}
...
type AnsTnmtRoomInfo struct {
  ...
  Gsn protocol.Gsn `thrift:"gsn,6,required" db:"gsn" json:"gsn"`
  State protocol.TnmtUserState `thrift:"state,7,required" db:"state" json:"state"`
  RoomLocation *protocol.RoomLocation `thrift:"room_location,8,required" db:"room_location" json:"room_location"`
  ContentsErrorCode int32 `thrift:"contents_error_code,9,required" db:"contents_error_code" json:"contents_error_code"`
  TraceID protocol.Buffer `thrift:"trace_id,10,required" db:"trace_id" json:"trace_id"`
}
...
var AnsTnmtRoomInfo_Result__DEFAULT *klperror.Error
func (p *AnsTnmtRoomInfo) GetResult_() *klperror.Error {
  if !p.IsSetResult_() {
...
func (p *AnsTnmtRoomInfo) GetRequestKey() protocol.RequestKey {
  return p.RequestKey
}

func (p *AnsTnmtRoomInfo) GetSsn() protocol.Ssn {
  return p.Ssn
}

func (p *AnsTnmtRoomInfo) GetCategoryID() protocol.CategoryId {
  return p.CategoryID
}

func (p *AnsTnmtRoomInfo) GetTnmtSrl() protocol.TnmtSrl {
  return p.TnmtSrl
}

func (p *AnsTnmtRoomInfo) GetGsn() protocol.Gsn {
  return p.Gsn
}

func (p *AnsTnmtRoomInfo) GetState() protocol.TnmtUserState {
  return p.State
}
var AnsTnmtRoomInfo_RoomLocation_DEFAULT *protocol.RoomLocation
func (p *AnsTnmtRoomInfo) GetRoomLocation() *protocol.RoomLocation {
...
func (p *AnsTnmtRoomInfo) GetTraceID() protocol.Buffer {
  return p.TraceID
}
...
type AnsLeaveTnmt struct {
  ...
  Gsn protocol.Gsn `thrift:"gsn,6,required" db:"gsn" json:"gsn"`
  State protocol.TnmtUserState `thrift:"state,7,required" db:"state" json:"state"`
  ContentsData protocol.Buffer `thrift:"contents_data,8,required" db:"contents_data" json:"contents_data"`
...
var AnsLeaveTnmt_Result__DEFAULT *klperror.Error
func (p *AnsLeaveTnmt) GetResult_() *klperror.Error {
  if !p.IsSetResult_() {
...
func (p *AnsLeaveTnmt) GetRequestKey() protocol.RequestKey {
  return p.RequestKey
}

func (p *AnsLeaveTnmt) GetSsn() protocol.Ssn {
  return p.Ssn
}

func (p *AnsLeaveTnmt) GetCategoryID() protocol.CategoryId {
  return p.CategoryID
}

func (p *AnsLeaveTnmt) GetTnmtSrl() protocol.TnmtSrl {
  return p.TnmtSrl
}

func (p *AnsLeaveTnmt) GetGsn() protocol.Gsn {
  return p.Gsn
}
...
func (p *AnsLeaveTnmt) GetTraceID() protocol.Buffer {
  return p.TraceID
}
