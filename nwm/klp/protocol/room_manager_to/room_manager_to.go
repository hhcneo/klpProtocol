...
type AnsSearchRoom struct {
  ...
  RoomInfos []*protocol.RoomInfoWithLocation `thrift:"room_infos,5,required" db:"room_infos" json:"room_infos"`
...
func (p *AnsSearchRoom) GetCategoryID() protocol.CategoryId {
  return p.CategoryID
}

func (p *AnsSearchRoom) GetRoomInfos() []*protocol.RoomInfoWithLocation {
  return p.RoomInfos
}

func (p *AnsSearchRoom) GetTraceID() protocol.Buffer {
  return p.TraceID
}
...
func (p *AnsSearchRoom)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  tSlice := make([]*protocol.RoomInfoWithLocation, 0, size)
  p.RoomInfos =  tSlice
  for i := 0; i < size; i ++ {
    _elem0 := &protocol.RoomInfoWithLocation{}
...
type AnsRoomInfoList struct {
  ...
  Result_ *klperror.Error `thrift:"result,2,required" db:"result" json:"result"`
  Ssn protocol.Ssn `thrift:"ssn,3,required" db:"ssn" json:"ssn"`
  RoomInfos []*protocol.RoomInfoWithLocation `thrift:"room_infos,4,required" db:"room_infos" json:"room_infos"`
...
func (p *AnsRoomInfoList) GetRequestKey() protocol.RequestKey {
  return p.RequestKey
}
...
func (p *AnsRoomInfoList) GetSsn() protocol.Ssn {
  return p.Ssn
}

func (p *AnsRoomInfoList) GetRoomInfos() []*protocol.RoomInfoWithLocation {
  return p.RoomInfos
}

func (p *AnsRoomInfoList) GetTraceID() protocol.Buffer {
  return p.TraceID
}
...
func (p *AnsRoomInfoList)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  p.RoomInfos =  tSlice
  for i := 0; i < size; i ++ {
    _elem2 := &protocol.RoomInfoWithLocation{}
...
type AnsRoomCreateInfo struct {
  RequestKey protocol.RequestKey `thrift:"request_key,1,required" db:"request_key" json:"request_key"`
  Result_ *klperror.Error `thrift:"result,2,required" db:"result" json:"result"`
  TCPAddress *protocol.InternetAddress `thrift:"tcp_address,3,required" db:"tcp_address" json:"tcp_address"`
  PmbAddress protocol.PmbAddress `thrift:"pmb_address,4,required" db:"pmb_address" json:"pmb_address"`
  Ssn protocol.Ssn `thrift:"ssn,5,required" db:"ssn" json:"ssn"`
  TraceID protocol.Buffer `thrift:"trace_id,6,required" db:"trace_id" json:"trace_id"`
}
...
type NtfRoomManagerServerStart struct {
  PmbAddress protocol.PmbAddress `thrift:"pmb_address,1,required" db:"pmb_address" json:"pmb_address"`
}
...
func (p *NtfRoomManagerServerStart) GetPmbAddress() protocol.PmbAddress {
  return p.PmbAddress
}
...
type AnsUserCount struct {
  ...
  Result_ *klperror.Error `thrift:"result,2,required" db:"result" json:"result"`
  Ssn protocol.Ssn `thrift:"ssn,3,required" db:"ssn" json:"ssn"`
  UserCounts map[protocol.CategoryId]int32 `thrift:"user_counts,4,required" db:"user_counts" json:"user_counts"`
  TraceID protocol.Buffer `thrift:"trace_id,5,required" db:"trace_id" json:"trace_id"`
}
...
func (p *AnsUserCount) GetRequestKey() protocol.RequestKey {
  return p.RequestKey
}
var AnsUserCount_Result__DEFAULT *klperror.Error
func (p *AnsUserCount) GetResult_() *klperror.Error {
  if !p.IsSetResult_() {
...
func (p *AnsUserCount) GetSsn() protocol.Ssn {
  return p.Ssn
}

func (p *AnsUserCount) GetUserCounts() map[protocol.CategoryId]int32 {
  return p.UserCounts
}

func (p *AnsUserCount) GetTraceID() protocol.Buffer {
  return p.TraceID
}
...
func (p *AnsUserCount)  ReadField4(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  tMap := make(map[protocol.CategoryId]int32, size)
  p.UserCounts =  tMap
  for i := 0; i < size; i ++ {
var _key4 protocol.CategoryId
    if v, err := iprot.ReadI32(ctx); err != nil {
...
func (p *AnsRoomList) GetRequestKey() protocol.RequestKey {
  return p.RequestKey
}
var AnsRoomList_Result__DEFAULT *klperror.Error
func (p *AnsRoomList) GetResult_() *klperror.Error {
  if !p.IsSetResult_() {
...
func (p *AnsRoomList) GetTraceID() protocol.Buffer {
  return p.TraceID
}
...
func (p *AnsCustomQuery) GetRequestKey() protocol.RequestKey {
  return p.RequestKey
}
var AnsCustomQuery_Result__DEFAULT *klperror.Error
func (p *AnsCustomQuery) GetResult_() *klperror.Error {
  if !p.IsSetResult_() {
...
func (p *AnsCustomQuery) GetSsn() protocol.Ssn {
  return p.Ssn
}
...
func (p *AnsCustomQuery) GetTraceID() protocol.Buffer {
  return p.TraceID
}
