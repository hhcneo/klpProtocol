...
type AnsUserState struct {
  ...
  LocationType UserLocationType `thrift:"location_type,6,required" db:"location_type" json:"location_type"`
...
func (p *AnsUserState) GetLocationType() UserLocationType {
...
func (p *AnsDisconnectUser) GetRequestKey() RequestKey {
  return p.RequestKey
}
var AnsDisconnectUser_Result__DEFAULT *Error
func (p *AnsDisconnectUser) GetResult_() *Error {
  if !p.IsSetResult_() {
...
func (p *AnsDisconnectUser) GetSsn() Ssn {
  return p.Ssn
}

func (p *AnsDisconnectUser) GetGsn() Gsn {
  return p.Gsn
}
