...
func (p *ReqVersion) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}

func (p *ReqVersion) GetSsn() Ssn {
  return p.Ssn
}
...
type ReqLogin struct {
  RequestKey ClientRequestKey `thrift:"request_key,1,required" db:"request_key" json:"request_key"`
  Ssn Ssn `thrift:"ssn,2,required" db:"ssn" json:"ssn"`
  MembershipType MembershipType `thrift:"membership_type,3,required" db:"membership_type" json:"membership_type"`
  MemberInfo Buffer `thrift:"member_info,4,required" db:"member_info" json:"member_info"`
}
...
func (p *ReqLogin) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}

func (p *ReqLogin) GetSsn() Ssn {
  return p.Ssn
}

func (p *ReqLogin) GetMembershipType() MembershipType {
  return p.MembershipType
}

func (p *ReqLogin) GetMemberInfo() Buffer {
  return p.MemberInfo
}
...
func (p *ReqLogout) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}
...
type ForwardMessage struct {
  ...
  ForwardType ForwardType `thrift:"forward_type,3" db:"forward_type" json:"forward_type"`
}
...
var ForwardMessage_ForwardType_DEFAULT ForwardType = 0

func (p *ForwardMessage) GetForwardType() ForwardType {
...
type ReqCreateAndJoinRoom struct {
  ...
  RoomOption Buffer `thrift:"room_option,3,required" db:"room_option" json:"room_option"`
  UserInfo Buffer `thrift:"user_info,4,required" db:"user_info" json:"user_info"`
  OptMinCategoryID *CategoryId `thrift:"opt_min_category_id,5" db:"opt_min_category_id" json:"opt_min_category_id,omitempty"`
...
func (p *ReqCreateAndJoinRoom) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}

func (p *ReqCreateAndJoinRoom) GetCategoryID() CategoryId {
  return p.CategoryID
}

func (p *ReqCreateAndJoinRoom) GetRoomOption() Buffer {
  return p.RoomOption
}

func (p *ReqCreateAndJoinRoom) GetUserInfo() Buffer {
  return p.UserInfo
}
var ReqCreateAndJoinRoom_OptMinCategoryID_DEFAULT CategoryId
func (p *ReqCreateAndJoinRoom) GetOptMinCategoryID() CategoryId {
...
type ReqJoinRoom struct {
  ...
  UserInfo Buffer `thrift:"user_info,3,required" db:"user_info" json:"user_info"`
}
...
func (p *ReqJoinRoom) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}

func (p *ReqJoinRoom) GetRoomID() RoomId {
  return p.RoomID
}

func (p *ReqJoinRoom) GetUserInfo() Buffer {
  return p.UserInfo
}
...
type ReqRandomJoinRoom struct {
  ...
  RoomOption Buffer `thrift:"room_option,5,required" db:"room_option" json:"room_option"`
  ...
  OptMinCategoryID *CategoryId `thrift:"opt_min_category_id,8" db:"opt_min_category_id" json:"opt_min_category_id,omitempty"`
...
func (p *ReqRandomJoinRoom) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}

func (p *ReqRandomJoinRoom) GetCategoryID() CategoryId {
  return p.CategoryID
}

func (p *ReqRandomJoinRoom) GetUserInfo() Buffer {
  return p.UserInfo
}
...
func (p *ReqRandomJoinRoom) GetRoomOption() Buffer {
  return p.RoomOption
}
...
var ReqRandomJoinRoom_OptMinCategoryID_DEFAULT CategoryId
func (p *ReqRandomJoinRoom) GetOptMinCategoryID() CategoryId {
  if !p.IsSetOptMinCategoryID() {
...
type ReqRandomJoinRoomWithServerOption struct {
  ...
  SearchCondition string `thrift:"search_condition,4,required" db:"search_condition" json:"search_condition"`
  RoomOption Buffer `thrift:"room_option,5,required" db:"room_option" json:"room_option"`
  ServerOptionJSON Buffer `thrift:"server_option_json,6,required" db:"server_option_json" json:"server_option_json"`
  ...
  OptMinCategoryID *CategoryId `thrift:"opt_min_category_id,9" db:"opt_min_category_id" json:"opt_min_category_id,omitempty"`
...
func (p *ReqRandomJoinRoomWithServerOption) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}

func (p *ReqRandomJoinRoomWithServerOption) GetCategoryID() CategoryId {
  return p.CategoryID
}

func (p *ReqRandomJoinRoomWithServerOption) GetUserInfo() Buffer {
  return p.UserInfo
}
...
func (p *ReqRandomJoinRoomWithServerOption) GetRoomOption() Buffer {
  return p.RoomOption
}

func (p *ReqRandomJoinRoomWithServerOption) GetServerOptionJSON() Buffer {
...
var ReqRandomJoinRoomWithServerOption_OptMinCategoryID_DEFAULT CategoryId
func (p *ReqRandomJoinRoomWithServerOption) GetOptMinCategoryID() CategoryId {
  if !p.IsSetOptMinCategoryID() {
...
func (p *ReqLeaveRoom) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}
...
func (p *ReqRoomList) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}
...
func (p *ReqChangeLobby) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}
...
type ReqJoinTnmt struct {
  ...
  UserInfo Buffer `thrift:"user_info,6,required" db:"user_info" json:"user_info"`
  RoomOption Buffer `thrift:"room_option,7,required" db:"room_option" json:"room_option"`
...
func (p *ReqJoinTnmt) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}

func (p *ReqJoinTnmt) GetCategoryID() CategoryId {
  return p.CategoryID
}

func (p *ReqJoinTnmt) GetTnmtSrl() TnmtSrl {
  return p.TnmtSrl
}
...
func (p *ReqJoinTnmt) GetUserInfo() Buffer {
  return p.UserInfo
}

func (p *ReqJoinTnmt) GetRoomOption() Buffer {
  return p.RoomOption
}
...
func (p *ReqLeaveTnmt) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}
