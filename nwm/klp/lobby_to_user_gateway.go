...
func (p *AnsEnterLobby) GetRequestKey() RequestKey {
  return p.RequestKey
}
var AnsEnterLobby_Result__DEFAULT *Error
func (p *AnsEnterLobby) GetResult_() *Error {
  if !p.IsSetResult_() {
...
func (p *AnsEnterLobby) GetSsn() Ssn {
  return p.Ssn
}

func (p *AnsEnterLobby) GetGsn() Gsn {
  return p.Gsn
}
...
func (p *AnsLeaveLobby) GetRequestKey() RequestKey {
  return p.RequestKey
}
var AnsLeaveLobby_Result__DEFAULT *Error
func (p *AnsLeaveLobby) GetResult_() *Error {
  if !p.IsSetResult_() {
...
func (p *AnsLeaveLobby) GetSsn() Ssn {
  return p.Ssn
}

func (p *AnsLeaveLobby) GetGsn() Gsn {
  return p.Gsn
}
...
func (p *AnsEnterRoomNotify) GetRequestKey() RequestKey {
  return p.RequestKey
}
var AnsEnterRoomNotify_Result__DEFAULT *Error
func (p *AnsEnterRoomNotify) GetResult_() *Error {
  if !p.IsSetResult_() {
...
func (p *AnsEnterRoomNotify) GetSsn() Ssn {
  return p.Ssn
}

func (p *AnsEnterRoomNotify) GetGsn() Gsn {
  return p.Gsn
}
...
func (p *AnsLeaveRoomNotify) GetRequestKey() RequestKey {
  return p.RequestKey
}
var AnsLeaveRoomNotify_Result__DEFAULT *Error
func (p *AnsLeaveRoomNotify) GetResult_() *Error {
  if !p.IsSetResult_() {
...
func (p *AnsLeaveRoomNotify) GetSsn() Ssn {
  return p.Ssn
}

func (p *AnsLeaveRoomNotify) GetGsn() Gsn {
  return p.Gsn
}
...
type AnsRoomCreateInfo struct {
  ...
  PmbAddress PmbAddress `thrift:"pmb_address,6,required" db:"pmb_address" json:"pmb_address"`
...
func (p *AnsRoomCreateInfo) GetGsn() Gsn {
  return p.Gsn
}
...
type AnsSearchRoom struct {
  ...
  Ssn Ssn `thrift:"ssn,3,required" db:"ssn" json:"ssn"`
  Gsn Gsn `thrift:"gsn,4,required" db:"gsn" json:"gsn"`
  RoomLocations []*RoomLocation `thrift:"room_locations,5,required" db:"room_locations" json:"room_locations"`
}
...
func (p *AnsSearchRoom) GetGsn() Gsn {
  return p.Gsn
}

func (p *AnsSearchRoom) GetRoomLocations() []*RoomLocation {
...
func (p *AnsSearchRoom)  ReadField5(ctx context.Context, iprot thrift.TProtocol) error {
  ...
  tSlice := make([]*RoomLocation, 0, size)
...
func (p *AnsRoomLocation) GetRequestKey() RequestKey {
  return p.RequestKey
}
var AnsRoomLocation_Result__DEFAULT *Error
func (p *AnsRoomLocation) GetResult_() *Error {
  if !p.IsSetResult_() {
...
func (p *AnsRoomLocation) GetSsn() Ssn {
  return p.Ssn
}

func (p *AnsRoomLocation) GetGsn() Gsn {
  return p.Gsn
}
var AnsRoomLocation_RoomLocation_DEFAULT *RoomLocation
func (p *AnsRoomLocation) GetRoomLocation() *RoomLocation {
