...
type CategoryInfo struct {
  CategoryID CategoryId `thrift:"category_id,1,required" db:"category_id" json:"category_id"`
...
func (p *CategoryInfo) GetCategoryID() CategoryId {
  return p.CategoryID
}
...
func (p *AnsCategoryList) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}
var AnsCategoryList_Result__DEFAULT *Error
func (p *AnsCategoryList) GetResult_() *Error {
  if !p.IsSetResult_() {
...
type AnsSearchRoom struct {
  RequestKey ClientRequestKey `thrift:"request_key,1,required" db:"request_key" json:"request_key"`
  Result_ *Error `thrift:"result,2,required" db:"result" json:"result"`
  RoomInfos []*RoomInfo `thrift:"room_infos,3,required" db:"room_infos" json:"room_infos"`
}
...
func (p *AnsSearchRoom) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}
...
func (p *AnsSearchRoom) GetRoomInfos() []*RoomInfo {
  return p.RoomInfos
}
...
func (p *AnsRoomInfoList) GetRequestKey() ClientRequestKey {
  return p.RequestKey
}
...
func (p *AnsRoomInfoList) GetRoomInfos() []*RoomInfo {
  return p.RoomInfos
}
...
func (p *ForwardFromLobbyContents) GetContentsMessage() Buffer {
