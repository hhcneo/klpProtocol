...
type ForwardToObject struct {
  ...
  Message Buffer `thrift:"message,4,required" db:"message" json:"message"`
}
...
func (p *ForwardToObject) GetSsn() Ssn {
  return p.Ssn
}
...
func (p *ForwardToObject) GetMessage() Buffer {
  return p.Message
}
...
func (p *ForwardToMessagingChannel) GetSsn() Ssn {
  return p.Ssn
}
...
func (p *ForwardToMessagingChannel) GetMessage() Buffer {
  return p.Message
}
