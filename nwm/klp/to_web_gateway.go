...
type ReqPmangBusinessLogic struct {
  ...
  UserState UserState `thrift:"user_state,4,required" db:"user_state" json:"user_state"`
...
func (p *ReqPmangBusinessLogic) GetRequestKey() RequestKey {
  return p.RequestKey
}

func (p *ReqPmangBusinessLogic) GetSsn() Ssn {
  return p.Ssn
}

func (p *ReqPmangBusinessLogic) GetGsn() Gsn {
  return p.Gsn
}

func (p *ReqPmangBusinessLogic) GetUserState() UserState {
  return p.UserState
}
...
func (p *ReqPmangBusinessLogic) GetBusinessContentsMessage() Buffer {
  return p.BusinessContentsMessage
}

func (p *ReqPmangBusinessLogic) GetSessionInfo() Buffer {
...
type ForwardMessage struct {
  ...
  SessionInfo Buffer `thrift:"session_info,4,required" db:"session_info" json:"session_info"`
}
...
func (p *ForwardMessage) GetSessionInfo() Buffer {
  return p.SessionInfo
}
